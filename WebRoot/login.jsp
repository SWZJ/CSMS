...
<body>
    <div class="wrap">
        <div class="container"><br><br><br><br><br><br><br><br><br><br>
            <h1>Login</h1>
            <form name="userForm" action="loginDo.jsp" onsubmit="return validateUserForm()" method="POST">
                <input type="text" class="form-control" name="account" placeholder="user account"/>
