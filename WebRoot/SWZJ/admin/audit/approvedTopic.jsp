...
<!-- END INFO TIP -->
	...
	<%
		...
		int recordCount = cdt.queryByCondition(0,2,1,0,queryStr).size();   		//记录总数
		...
		List<CDTopic> cutList = cdt.cutPageData(Page,pageSize,0,2,1,0,"updated_at","DESC",queryStr);
		request.setAttribute("cutList", cutList);
	%>
	
    <div class="panel">
        <div class="panel-heading" >
            <h3 class="panel-title">已经审核并通过的课题</h3>
        </div>
        <div class="panel-heading">
