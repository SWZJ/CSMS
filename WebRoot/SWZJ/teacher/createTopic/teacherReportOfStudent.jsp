		...
		<div class="panel-body">
			<table class="table table-hover">
				...
				<c:url value="/servlet/DeleteFileServlet" var="deleteurl">
					...
					<tr>
						<td>
							<a href="${downurl}&location=teacherReportOfStudent&branch=student&id=${user.getTeacherID()}">下载</a>&ensp;
							<a href="${deleteurl}&location=teacherReportOfStudent&branch=student&id=${user.getTeacherID()}" onclick="return confirm('确定要删除这个课题报告吗？')">删除</a>
						</td>
						<td>${me.value}</td>
					</tr>
				</c:forEach>
