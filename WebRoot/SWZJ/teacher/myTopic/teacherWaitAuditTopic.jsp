...
<!-- END INFO TIP -->
    ...
    <div class="panel">
        <div class="panel-heading" >
            <h3 class="panel-title">正在等待审核的课题</h3>
            <div class="right">
		...
		<div class="panel-body">
			<table class="table table-hover">
				...
				<%
					...
					int recordCount = cdt.queryByCondition(0,0,0,user.getTeacherID(),queryStr).size();   		//记录总数
					...
					List<CDTopic> cutList = cdt.cutPageData(Page,pageSize,0,0,0,user.getTeacherID(),"updated_at","DESC",queryStr);
