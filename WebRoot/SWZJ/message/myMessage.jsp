			...
			<div class="col-md-12">
				<div class="panel">
			        <div class="panel-heading" >
			            <h3 class="panel-title">${lan.equals("en")?"My Message":"所有消息"}</h3>
			            <div class="right">
					...
					<div class="panel-body" style="text-align:center;font-size:24px">
						${lan.equals("en")?"Here are all the messages you've received":"这里是你收到的所有信息"}
					</div>
				</div>
			</div>
			...
			<c:if test="${myMesList.size()==0 }">
				<div class="col-md-12">
					<div class="panel">
						...
						<div class="panel-body">
							<p style="text-align:center;font-size:20px">${lan.equals("en")?"You haven't received any messages yet!!!":"你还没有收到任何消息！！！"}</p>
						</div>
					</div>
				</div>
			</c:if>
