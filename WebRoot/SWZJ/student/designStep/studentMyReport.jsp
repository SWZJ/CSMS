			...
			<table class="table table-hover">
				...
				<c:url value="/servlet/DownLoadServlet" var="downurl">
					...
					<%if(queryStr.equals("")==true){%>
						<a href="${downurl}&location=studentMyReport&branch=student&id=${user.getTeacherID()}">下载</a>
					<%}else{%>
						<a href="${downurl}&location=studentMyReport&branch=student&id=${user.getTeacherID()}&queryStr=<%=queryStr%>">下载</a>
					<%}%>
					</td>
					<td>${me.value}</td>
				</c:forEach>
