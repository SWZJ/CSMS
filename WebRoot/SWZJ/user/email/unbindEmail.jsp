	...
	<div class="col-md-8 col-md-offset-2" style="padding: 100px 70px 0 70px;">
		<div class="panel panel-default" style="text-align:center; vertical-align:middel;">
			...
			<div class="panel-body">
				<form class="form-horizontal" role="form" method="post" action="/CSMS/SWZJ/user/email/unbindEmailDo.jsp" onsubmit="return checkAll()">
					<br>
					...
					<div class="form-group">
						<%if(user.getEmail()!=null&&user.getEmail().length()!=0){%>
						<button type="submit" title="发送验证邮件解绑邮箱" class="btn btn-primary">解绑邮箱</button>
						<%}else{ %>
