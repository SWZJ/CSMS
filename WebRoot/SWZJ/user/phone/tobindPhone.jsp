	...
	<div class="col-md-8 col-md-offset-2" style="padding: 100px 70px 0 70px;">
		<div class="panel panel-default" style="text-align:center; vertical-align:middel;">
			<div class="panel-heading">
           		<h3 class="panel-title">手机号改绑</h3>
        	</div>
			<div class="panel-body">
				<form class="form-horizontal" role="form" method="post" action="validatePhone.jsp?operation=tobindPhone&id=<%=user.getID() %>" onsubmit="return checkAll()">
					<br>
					...
					<div class="form-group">
						<%if(user.getPhone()!=null&&user.getPhone().length()!=0){%>
						<button type="submit" title="改绑手机号" class="btn btn-primary">改绑手机号</button>
						<%}else{ %>
